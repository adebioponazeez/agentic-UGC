...
- Durable checkpoints and digest-bound approval resume.
- Provider budgets, retries, circuit breaker, validation, and telemetry.
- Injection boundaries, workflow validation, and global benchmark.

## [0.1.0] - 2026-08-22

- Meta, UGC, venture, and ecosystem workflows.
- Candidate, red-team, evaluation, revision, memory, local provider, and mock provider.
